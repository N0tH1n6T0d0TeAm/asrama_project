...
class asramaProject extends Controller
{
    ...
    public function postLogin(Request $req){
        ...
        return redirect('/')->with("Maaf Akun Anda Masukan Salah, Coba Lagi");
    }
    ...
    public function lihat_pengguna(){
        $table = User::where('level','pamong')->orWhere('level','guru')->orWhere('level','kepala sekolah')->orWhere('level','yayasan')->get();
